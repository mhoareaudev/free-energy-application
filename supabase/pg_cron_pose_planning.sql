-- ═══════════════════════════════════════════════════════════════════
-- PLANNING POSE — Cron job jeudi 8h (La Réunion)
...
-- '0 4 * * 4' = chaque jeudi à 4h UTC = 8h heure La Réunion (UTC+4)
...
FROM cron.job
WHERE jobname = 'pose-planning-weekly';

-- ═══════════════════════════════════════════════════════════════════
-- POUR TESTER MANUELLEMENT (sans attendre jeudi) :
